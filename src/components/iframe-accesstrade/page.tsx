const IframeAccesstrade = () => {
  return (
    <div className='w-full iframe-accesstrade'>
      <div id='layout-wrapper'>
        <main className='atEQPOIVFSDFSDG-voucher-main'>
          <div className='fa-3x'>
            <div className='hide fas fa-spinner'>
...
h78.747C231.693,100.736,232.77,106.162,232.77,111.694z'
          ...
          <div
            className='atEQPOIVFSDFSDG-container'
            style={{ display: 'none' }}
          >
            <div className='atEQPOIVFSDFSDG-first-block'>
              ...
              <div className='atEQPOIVFSDFSDG-filter-keyword'>
                <ul className='atEQPOIVFSDFSDG-tags' />
              </div>
            </div>
...
export default IframeAccesstrade
